...
public class ShapesJPanel extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		Graphics2D g2d = (Graphics2D) g; // faz uma cercao em g para Graphics2D
		...
		// desenha retangulo arredondado 2D com um fundo armazenado em buffer
		...
		// desenha uma linha em 2D utilizando traco
		float[] dashes = {10}; // especifica padrao de traco
